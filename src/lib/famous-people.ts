...
export const FAMOUS_PEOPLE: FamousPerson[] = [
  ...
  },
  {
    ...
    descBn: "আজاد হিন্দ ফৌজের অধিনায়ক যিনি 'তোমরা আমাকে রক্ত দাও, আমি তোমাদের স্বাধীনতা দেব' স্লোগানে কাঁপিয়েছিলেন ব্রিটিশ রাজ।",
    emoji: "🎖️",
  ...
  },
  {
    ...
    emoji: "🌌",
    wikiUrl: "https://bn.wikipedia.org/wiki/সুব್ರহ্মণ্যন_চন্দ্রশেখর",
  ...
  },
  {
    ...
    descBn: "'গান্ধী বুড়ি' নামে পরিচিতা ৭৩ বছর বয়সী বীরাঙ্গনা যিনি ভারত ছাড়ো আন্দোলনে تেরঙা পতাকা হাতে ব্রিটিশের গুলিতে শহীদ হন।",
    emoji: "🇮🇳",
  ...
  },
  {
    ...
    emoji: "🌍",
    wikiUrl: "https://bn.wikipedia.org/wiki/নেলসন_ม্যান্ডেলা",
...
export const HISTORIC_EVENTS: HistoricEvent[] = [
  ...
  },
  {
    ...
    emoji: "🇧🇩",
    wikiUrl: "https://bn.wikipedia.org/wiki/বাংলা_ভাষা_আندোলন",
  ...
  },
  {
    ...
    descBn: "লর্ড কার্জনের বঙ্গভঙ্গ সিদ্ধান্তের প্রতিবাদে洍কলকাতার টাউন হলে বিদেশী পণ্য বয়কট এবং স্বদেশী পণ্য ব্যবহারের ঐতিহাসিক ডাক দেওয়া হয়।",
    category: "bengali-cultural-events",
    emoji: "🧵",
...
export const IMPORTANT_DATES: ImportantDate[] = [
  ...
  },
  {
    ...
    category: "un-international-observance-days",
    descBn: "যোগাভ্যাসের মানসিক ও শারীরিক স্বাস্থ্যগত উপকারিতা প্রচারের উদ্দেশ্যে জাতিসংঘের সাধারণ পরিষদ কর্তৃক घोषित দিবস।",
    emoji: "🧘‍♂️",
...
for (let i = 0; i < 150; i++) {
  ...
  generatedEvents.push({
    ...
    descBn: `মানব ইতিহাসের গতিপথ পরিবর্তনকারী একটি স্মরণীয় ঘটনা যা সামাজিক, political ও আঞ্চলিক সংস্কৃতিতে গভীর প্রভাব ফেলেছিল।`,
    category: currentCat,
    emoji: "📜",
    wikiUrl: "https://bn.wikipedia.org/wiki/বিশেষ:র্যান্ডম"
  });
