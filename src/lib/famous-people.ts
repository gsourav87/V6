...
export const FAMOUS_PEOPLE: FamousPerson[] = [
  ...
  },
  {
    ...
    emoji: "🧸",
    wikiUrl: "https://bn.wikipedia.org/wiki/kailash_satyarthi",
  ...
  },
  {
    ...
    deathMD: "01-08",
    deathYear: 1642,
    role: "ج্যোতির্বিজ্ঞানী ও পদার্থবিদ",
  ...
  },
  {
    ...
    descBn: "বৈذجুতিক বাল্ব, ফোনোগ্রাফ ও মোশন পিকচার ক্যামেরাসহ হাজারেরও বেশি পেটেন্টের অধিকারী ইতিহাসের শ্রেষ্ঠতম উদ্ভাবক।",
    emoji: "💡",
