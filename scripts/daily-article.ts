...
নিয়মাবলী:
- বডি টেক্সট মার্কডাউনে লেখো: ## এবং ### হেডিং, **বোল্ড**, *ইটালিক*, - বা ১. লিস্ট, > উক্তি — এসবই ব্যবহার করতে পারো। কোনো লিংক ([text](url)) বা ছবি ![alt](src) বসিও না, ওগুলো আলাদাভাবে যোগ হবে। মার্কডাউন টেবিল (| ... | ... |) কখনোই ব্যবহার কোরো না — সাইটের রেন্ডারার তা সাপোর্ট করে না; তুলনা বা তালিকাভিত্তিক তথ্যের জন্য লিস্ট বা সাধারণ অনুচ্ছেদ ব্যবহার করো।
